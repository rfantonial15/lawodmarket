...
class _UsernameState extends State<username> {
  ...
  TextEditingController confirmUsernameController = TextEditingController();
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 59),
                SizedBox(height: 10),
                buildTextField('New Username', 'Gaga Oh Lala', newUsernameController),
                SizedBox(height: 23),
                buildTextField('Confirm Username', 'Gaga Oh Lala', confirmUsernameController),
                SizedBox(height: 30),
