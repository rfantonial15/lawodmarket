          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 59),
                SizedBox(height: 10),
                buildTextField('New Phone Number', 'New Phone Number', newPhoneNumberController),
                SizedBox(height: 23),
                buildTextField('Confirm Phone Number', 'Confirm Phone Number', confirmPhoneNumberController),
                SizedBox(height: 30),
