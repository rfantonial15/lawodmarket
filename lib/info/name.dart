...
class _NameState extends State<name> {
  ...
  TextEditingController confirmFullNameController = TextEditingController();
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 59),
                SizedBox(height: 10),
                buildTextField('New Full Name', 'New Full Name', newFullNameController),
                SizedBox(height: 23),
                buildTextField('Confirm Full Name', 'Confirm Full Name', confirmFullNameController),
                SizedBox(height: 30),
